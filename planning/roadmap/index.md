...
- [IssueOps v2 — minimal authority protocol proof programme](issueops-v2.md) — completed with a **Reject** decision after Proof A and Proof B produced reusable evidence, Proof C exposed the C4 compatibility gap, one bounded remediation failed to restore compatibility, and owner disposition [#221](https://github.com/8ft0-ai/IssueOps/issues/221) retained `v0.3.0`; actual close-out is recorded in the [IssueOps v2 delivery record](../delivery/issueops-v2-minimal-authority-protocol-proof-programme.md).

Proof A and Proof B remain retained proof artefacts within this completed rejected programme. They are historical evidence, not active approved roadmap work.
...
None. The IssueOps v2 proof programme completed with a **Reject** decision; its Proof A and Proof B artefacts are retained as historical proof evidence rather than active roadmap work.
