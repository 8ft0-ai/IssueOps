...
- [Why execution deviations are evidence](why-execution-deviations-are-evidence.md) — why accidental operations remain review evidence without automatically becoming bugs or backlog items.
